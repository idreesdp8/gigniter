		...
		function add(){     
			...
			if(isset($_POST) && !empty($_POST)){ 
				...
				// validation fail
					...
					$datas = array('name' => $name,'role_id' => $role_id,'email' => $email,'password' => $password,'mobile_no' => $mobile_no,'phone_no' => $phone_no,'company_name' => $company_name,'address' => $address,'created_on' => $created_on,'status' => $status,'image' => $imagename,'parent_id' => $parent_id); 
