                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="ticket_limit" id="ticket_limit" class="form-control" min="0" data-error="#ticket_limit1">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="threshold" id="threshold" class="form-control" min="0" data-error="#threshold1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="goal_amount" id="goal_amount" class="form-control" min="0" data-error="#goal_amount1">
