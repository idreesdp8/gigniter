          ...
          <div class="col-lg-12">
            ...
            <div class="panel panel-flat">
              ...
              <div class="panel-body">
                <?php $form_act = "admin/members/add"; ?>
                  ...
                  <div class="row">
                    <div class="col-md-9">
                      <div class="form-group">
                        ...
                        <div class="col-md-8">
                          <input name="first_name" id="first_name" type="text" class="form-control" value="<?php echo set_value('first_name'); ?>" data-error="#first_name1">
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-8">
                          <input name="last_name" id="last_name" type="text" class="form-control" value="<?php echo set_value('last_name'); ?>" data-error="#last_name1">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8">
                          <textarea name="address" id="address" type="text" class="form-control" data-error="#address1" rows="5"><?php echo set_value('address'); ?></textarea>
                          <span id="address1" class="text-danger"><?php echo form_error('address'); ?></span> </div>
                      </div>
                      <div class="form-group">
                        <label class="col-md-3 control-label" for="status">Account Status<span class="reds"> </span></label>
                        <div class="col-md-8">
