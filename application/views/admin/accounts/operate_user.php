    ...
    <div class="panel panel-flat">
      ...
      <?php 
		if(isset($args1) && $args1>0){
			$form_act = "accounts/operate_user/".$args1;
		}else{
			$form_act = "accounts/operate_user";
		} ?>
        ...
        <?php }	?>
              &nbsp;
              <button type="button" class="btn border-slate text-slate-800 btn-flat" onClick="window.location='<?php echo site_url('accounts/users_list'); ?>';"><i class="glyphicon glyphicon-chevron-left position-left"></i>Cancel</button> 
