  ...
  <div class="page-content">
    ...
    <div class="content-wrapper">
      ...
      <div class="content">
        ...
        <?php } ?>
        <script>
        	function operate_galleries_list(){  
				$(document).ready(function(){ 
					...
					$.ajax({
						method: "POST",
						url: "<?php echo site_url('/admin/galleries/index2/'); ?>",
						data: { page: 0, sel_per_page_val:sel_per_page_val, s_val: s_val, status_val: status_val},
						beforeSend: function(){
							$('.loading').show();
						},
			...
			function view_gallery_data(paras1){  
			 
				if(paras1>0){	  	
					$(document).ready(function(){       
					<?php
						$domn_dtl_popup_url = 'admin/galleries/view_gallery_data/';
						...
						$('#modal_remote_data_detail').modal({show: false})
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header bg-teal-400">
                ...
                <h5 class="modal-title">Gallery Detail's</h5>
              </div>
        ...
        <div class="panel panel-flat">
          ...
          <div class="panel-body">
            ...
            <input type="hidden" name="add_new_link" id="add_new_link" value="<?php echo site_url('admin/galleries/add'); ?>">
            <input type="hidden" name="cstm_frm_name" id="cstm_frm_name" value="datas_list_forms">
            <form name="datas_list_forms" id="datas_list_forms" action="<?php echo site_url('admin/galleries/trash_multiple'); ?>" method="post">
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group mb-md">
                    <div class="col-md-1">
                      <select name="per_page" id="per_page" class="form-control input-sm mb-md cstm_select2" onChange="operate_galleries_list();">
                    ...
                    <div class="col-md-3">
                      <input name="s_val" id="s_val" onKeyUp="operate_galleries_list();" placeholder="Search..." type="text" class="form-control input-sm mb-md">
                    </div>
                    <div class="col-md-3">
                      <select name="status" id="status" class="form-control cstm_select2" onChange="operate_galleries_list();">
                    ...
                    <div class="col-md-3 pull-right">
                      <div class="dt-buttons"> <a class="dt-button btn border-slate text-slate-800 btn-flat mrglft5" tabindex="0" aria-controls="DataTables_Table_1" href="javascript:void(0);" onClick="return operate_multi_deletions('datas_list_forms');"> <span><i class="glyphicon glyphicon-remove-circle position-left"></i>Delete</span></a> <a class="dt-button btn border-slate text-slate-800 btn-flat mrglft5" tabindex="0" aria-controls="DataTables_Table_1" href="<?= site_url('admin/galleries/add'); ?>"><span><i class="glyphicon glyphicon-plus position-left"></i>New</span></a> </div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <table class="table table-bordered table-striped table-hover">
				...
				if(isset($records) && count($records)>0){
					foreach($records as $record){   
						$operate_url = 'admin/galleries/update/'.$record->id;
						$operate_url = site_url($operate_url); 
						
						$trash_url = 'admin/galleries/trash_aj/'.$record->id;
                  ...
                  <tr class="<?php echo ($sr%2==0)?'gradeX':'gradeC'; ?>">
                    ...
                    <td class="text-center"><ul class="icons-list">
                        <li class="text-primary-600"><a href="javascript:void(0);" onClick="return view_gallery_data('<?php echo $record->id; ?>');"  data-toggle="modal" data-target="#modal_remote_data_detail"><i class=" icon-equalizer3"></i></a></li>
