								...
								<div class="col-md-3">
									<div class="form-group">
										<select name="is_paid" id="is_paid" class="form-control" onChange="document.getElementById('datas_form').submit();">
											...
											<option value="1" <?php echo (isset($_POST['is_paid']) && $_POST['is_paid'] == 1) ? 'selected="selected"' : ''; ?>> Yes </option>
											<option value="0" <?php echo (isset($_POST['is_paid']) && $_POST['is_paid'] == 0) ? 'selected="selected"' : ''; ?>> No </option>
										</select>
									</div>
								</div>
							</div>
