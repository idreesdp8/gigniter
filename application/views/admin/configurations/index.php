...
<body>
		...
		<div class="content-wrapper">
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						<form action="<?php echo admin_base_url() ?>configurations/add" method="post" id="datas_form">
							<div class="row">
								<div class="col-md-4">
									<div class="form-group">
										<label>Key <span class="text-danger">*</span></label>
										<input type="text" class="form-control" placeholder="Enter configuration key" name="key" data-error="#key1">
										<span id="key1" class="text-danger" generated="true"><?php echo form_error('key'); ?></span>
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										<label>Value <span class="text-danger">*</span></label>
										<input type="text" class="form-control" placeholder="Enter configuration value" name="value" data-error="#value1">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<input type="text" class="form-control" placeholder="Enter configuration label" name="label" data-error="#label1">
										...
										<tr>
											...
											<td>
												<div class="d-flex">
													...
													<form action="<?php echo admin_base_url() ?>configurations/trash/<?php echo $record->id ?>">
				...
				<div id="editModal" class="modal fade" tabindex="-1">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<form action="<?php echo admin_base_url() ?>configurations/update" method="post">
								<input type="hidden" id="edit-id" class="form-control" name="id">
								<div class="modal-body">
									<div class="form-group">
										<label>Value</label>
										<input type="text" id="edit-value" class="form-control" name="value">
									</div>
									<div class="form-group">
										<label>Label</label>
	...
	<script>
		$(document).ready(function() {
			...
			$('#sidebar_config a').addClass('active');
			...
			var validator = $('#datas_form').validate({
				...
				messages: {
					key: {
						required: "Key is required field"
					},
					label: {
			...
			$('.editModal').click(function() {
				...
				// console.log(id);
				$.ajax({
					url: base_url + 'configurations/edit',
					type: 'post',
					data: {
						id: id
					},
