          ...
          <div class="col-lg-12">
            ...
            <div class="panel panel-flat">
              ...
              <div class="panel-body">
                <?php $form_act = "admin/products/add"; ?>
                  ...
                  <div class="row">
                    <div class="col-md-9">
                      <div class="form-group">
                        ...
                        <div class="col-md-8">
                          <input name="product_name" id="product_name" type="text" class="form-control" value="<?php echo set_value('product_name'); ?>" data-error="#product_name1">
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-8">
                          <input name="links" id="links" type="text" class="form-control" value="<?php echo set_value('links'); ?>" data-error="#links1">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8"><textarea name="summary" id="summary" cols="40" rows="4" class="form-control" data-error="#summary1"><?php echo set_value('summary'); ?></textarea> 
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-8"><textarea name="detail" id="detail" cols="40" rows="7" class="form-control" data-error="#detail1"><?php echo set_value('detail'); ?></textarea> 
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8">
                          <input name="views" id="views" type="text" class="form-control" value="<?php echo set_value('views'); ?>" data-error="#views1">
