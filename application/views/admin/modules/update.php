    ...
    <div class="content-wrapper">
      ...
      <div class="content">
		...
		if(isset($args1) && $args1>0){
			$form_act = "admin/modules/update/".$args1;
		} ?>
            ...
            if(isset($par_modules_arrs) && count($par_modules_arrs)>0){
				...
				if(isset($chd_modules_arrs) && count($chd_modules_arrs)>0){
					foreach($chd_modules_arrs as $chd_modules_arr){
                      ...
                      <span id="parent_id1" class="text-danger" generated="true"><?php echo form_error('parent_id'); ?></span> </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      ...
                      <span id="icon_name1" class="text-danger" generated="true"><?php echo form_error('icon_name'); ?></span> </div>
                  </div>
                  <div class="form-group">
                  ...
                  if(isset($_POST['sort_order']) && strlen($_POST['sort_order'])>0){
                    ...
                    $temp_sort_order = $max_sort_val+1;
                      ...
                      <span id="sort_order1" class="text-danger" generated="true"><?php echo form_error('sort_order'); ?></span> </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      ...
                      <span id="controller_name1" class="text-danger" generated="true"><?php echo form_error('controller_name'); ?></span> </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      ...
                      <?php } ?>
                      &nbsp;
                      <button type="button" class="btn border-slate text-slate-800 btn-flat" onClick="window.location='<?php echo site_url('admin/modules/index'); ?>';"><i class="glyphicon glyphicon-chevron-left position-left"></i>Cancel</button>
                    </div>
                  </div>
                </form>
