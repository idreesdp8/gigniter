...
$add_res_nums =  $this->general_model->check_controller_method_permission_access('Admin/Modules','add',$this->dbs_role_id,'1'); 
		
$update_res_nums =  $this->general_model->check_controller_method_permission_access('Admin/Modules','update',$this->dbs_role_id,'1');   

$trash_res_nums =  $this->general_model->check_controller_method_permission_access('Admin/Modules','trash',$this->dbs_role_id,'1');
  ...
  <div class="page-content">
    ...
    <div class="content-wrapper">
      ...
      <div class="content">
        ...
        <?php } ?>
        <input type="hidden" name="add_new_link" id="add_new_link" value="<?php echo site_url('admin/modules/add'); ?>">
        ...
        <div class="panel panel-flat">
          ...
          <form name="datas_list_forms" id="datas_list_forms" action="<?php echo site_url('admin/modules/trash_multiple'); ?>" method="post">
            <div id="dyns_list">
		...
		if(isset($par_modules_arrs) && count($par_modules_arrs)>0){
			foreach($par_modules_arrs as $par_modules_arr){
				$operate_url = 'admin/modules/update/'.$par_modules_arr->id;
                $operate_url = site_url($operate_url);
                
                $trash_url = 'admin/modules/trash_aj/'.$par_modules_arr->id;
                $trash_url = site_url($trash_url); ?>
                  <tr>
                    <td><div class="checkbox">
                        <label for="status">
                        <input type="checkbox" name="multi_action_check[]" id="multi_action_check_<?php echo $par_modules_arr->id; ?>" value="<?php echo $par_modules_arr->id; ?>" class="styled">
                        <?php echo $sr; ?> </label>
                      </div></td>
			...
			if(isset($chd_modules_arrs) && count($chd_modules_arrs)>0){
				foreach($chd_modules_arrs as $chd_modules_arr){
					$operate_url_2 = 'admin/modules/update/'.$chd_modules_arr->id;
					$operate_url_2 = site_url($operate_url_2);
					
					$trash_url_2 = 'admin/modules/trash_aj/'.$chd_modules_arr->id;
					$trash_url_2 = site_url($trash_url_2);  ?>
                  <tr>
                    <td><div class="checkbox">
                        <label for="status">
                        <input type="checkbox" name="multi_action_check[]" id="multi_action_check_<?php echo $chd_modules_arr->id; ?>" value="<?php echo $chd_modules_arr->id; ?>" class="styled">
                        <?php echo $sr; ?> </label>
                      </div></td>
                    <td>&nbsp; - &nbsp;
                      <?= stripslashes($chd_modules_arr->name); ?></td>
