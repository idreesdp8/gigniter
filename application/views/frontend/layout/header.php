    ...
    <div class="container">
        <div class="header-wrapper">
            ...
            <ul class="menu">
                ...
                $vs_user_name = $this->session->userdata('us_username');
                if (!$vs_id) :
                ?>
                ...
                ?>
                    <li>
                        <a href="#0">
                            ...
                            <p class="user-name"><?php echo $vs_user_name !== '' ? $vs_user_name : 'User' ?> <span class="name-divider">|</span> My account</p>
                        </a>
                ...
                <li>
                    <a href="<?php echo user_base_url() ?>cart/checkout" id="cart_menu">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="#e9eeff">
