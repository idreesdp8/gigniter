								...
								foreach ($tickets_rows as $tickets_row) { ?>
									<article class="card fl-left">
										...
										<?php
											...
											/*if (in_array('Physical', $venues_arrs)) { ?> <button type="button" class="btn btn-primary send_ticket" id="send_ticket_<?php echo $tickets_row->ticket_id; ?>" data-ticket_id="<?php echo $tickets_row->ticket_id; ?>" data-ticket_token="<?php echo $tickets_row->qr_token; ?>">Send Ticket</button> <?php  
											}else{
												echo 'N/A';
											}*/ 
