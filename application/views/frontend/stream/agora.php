...
<head>
  ...
  <link rel="stylesheet" href="<?php echo user_asset_url().'agora_vendor/bootstrap.min.css' ?>">
  <link rel="stylesheet" href="<?php echo user_asset_url().'agora_vendor/index.css' ?>">
</head>
<body>
    ...
    <form id="join-form">
      <div class="row join-info-group">
          <div class="col-sm">
            ...
            <input id="appid" value="d7ee24815bdf415298568adbe78ca9a6" type="text" placeholder="enter appid" required>
          ...
          <div class="col-sm">
            ...
            <input id="token" value="006d7ee24815bdf415298568adbe78ca9a6IAA8vNB/QTqpn06hhXDR1KzrkQI1c3itWaRU+uhMJcd0SArCxmsAAAAAEAALtir+sq2HYAEAAQCxrYdg" type="text" placeholder="enter token">
          ...
          <div class="col-sm">
            ...
            <input id="channel" value="channel1" type="text" placeholder="enter channel name" required>
  ...
  <script src="<?php echo user_asset_url().'agora_vendor/jquery-3.4.1.min.js' ?>"></script>
  <script src="<?php echo user_asset_url().'agora_vendor/bootstrap.bundle.min.js' ?>"></script>
  <script src="<?php echo user_asset_url().'agora_vendor/AgoraRTC_N-4.4.0.js' ?>"></script>
  <script src="<?php echo user_asset_url().'agora_vendor/index.js' ?>"></script>
</body>
</html>
