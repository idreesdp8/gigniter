                ...
                <div class="row">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                    <label>
                      ...
                      <input type="time" id="end_time" class="time" name="end_time" onFocus="(this.type='time')" onBlur="if(!this.value)this.type='text'" required="required" value="<?php echo $gig->end_time ? date('H:i:s', strtotime($gig->end_time)) : '' ?>">
              ...
              <div class="panel panel-primary setup-content" id="step-3"> 
                ...
                <div class="row">
                    ...
                    <label>
                      Profile Image
                       <div> <img id="img2" src="<?php echo $user->image ? profile_image_url() . $user->image : user_asset_url() . 'images/icons/img-demo-bg.png' ?>" alt="your image" /> <a><img src="<?php echo $user->image ? '' : user_asset_url() . 'images/icons/img-plus.png' ?>" id="icon_for_upload"></a>
						<input type='file' id="my-file2" name="image" hidden="hidden" accept="image/*" onChange="readURL2(this);" /> </div>
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                    <label>
                      Stripe integration
                      <input type="text" id="stripe" name="stripe" value="<?php echo isset($user->stripe) ? $user->stripe : ''; ?>" required="required" />
                    </label>
                  </div>
                  <div class=" col-lg-6 col-md-6 col-sm-12 col-12">
                  </div>
