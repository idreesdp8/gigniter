                ...
                <div class="row">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                    <label>
                      ...
                      <input type="time" id="start_time" class="time" name="start_time" onFocus="(this.type='time')" onBlur="if(!this.value)this.type='text'" required="required" value="<?php echo $gig->start_time ? date('H:i:s', strtotime($gig->start_time)) : '' ?>" <?php echo $gig->is_approved ? 'disabled' : '' ?>>
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      $('#add_tier_button').click(function() {
        ...
        div.append('<div class="col-lg-12 col-md-12 col-sm-12 col-12 mt-3 ticket_tier">' +
          '<div id="tier' + tier + '">' +
          '<div class="d-flex justify-content-between">' +
          '<h5>Tier ' + tier + '</h5>' +
          '<div class="text-danger cursor-pointer remove_tier"><i class="fas fa-times"></i></div>' +
