        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
          <div class="stepwizard">
            <div class="stepwizard-row row setup-panel">
              <div class="stepwizard-step"> <a href="#step-1" type="button" class="btn btn-circle line progress_step_1 btn-success-circle">1</a>
                <p><small>Basic Info</small></p>
              </div>
              <div class="stepwizard-step"> <a href="#step-2" type="button" class="btn btn-default btn-circle line progress_step_2">2</a>
                <p><small>Ticket Tiers</small></p>
              </div>
              <div class="stepwizard-step"> <a href="#step-3" type="button" class="btn btn-default btn-circle line progress_step_3">3</a>
                <p><small>About You</small></p>
              </div>
              <div class="stepwizard-step"> <a href="#step-4" type="button" class="btn btn-default btn-circle line progress_step_4">4</a>
                <p><small>Test link</small></p>
              </div>
              <div class="stepwizard-step"> <a href="#step-5" type="button" class="btn btn-default btn-circle progress_step_5">5</a>
    ...
    <div class="container step-container">
      ...
      <form role="form" method="post" action="<?php echo user_base_url() ?>gigs/update" id="basic_info_form" enctype="multipart/form-data">
        ...
        <div class="panel panel-primary setup-content" id="step-1">
          ...
          <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
              <label> Enter Gig Title
              <input type="text" id="title" name="title" value="<?php echo $gig->title; ?>" required="required" <?php echo $gig->status ? 'disabled' : '' ?>>
              <span id="title1" class="text-danger" generated="true"><?php echo form_error('title'); ?></span> </label>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
              <label> Enter Gig subtitle
              <input type="text" id="subtitle" name="subtitle" value="<?php echo $gig->subtitle; ?>" required="required">
              <span id="subtitle1" class="text-danger" generated="true"><?php echo form_error('subtitle'); ?></span> </label>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-12 col-12">
              <label> Enter Gig Category
              ...
              <span id="category1" class="text-danger" generated="true"><?php echo form_error('category'); ?></span> </label>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-12 col-12">
              <label> Enter Gig Genre
              ...
              <span id="genre1" class="text-danger" generated="true"><?php echo form_error('genre'); ?></span> </label>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-12 col-12">
              <label>
              Venue
            ...
            <!-- <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                    <label>
                      ...
                      or Pitch Video
                      <div>
                        <img class="object-fit-cover" id="img" src="<?php echo $gig->
            poster ? poster_url() . $gig->poster : user_asset_url() . 'images/icons/img-demo-bg.png' ?>" alt="your image" /> <a><img src="<?php echo $gig->poster ? '' : user_asset_url() . 'images/icons/img-plus.png' ?>" id="icon_for_upload"></a>
            <input type='file' name="poster" id="poster" hidden="hidden" accept="image/*" onChange="readURL(this);" />
          </div>
          </label>
        </div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-12" id="gig_address" <?php echo $gig->address == '' ? 'style="display: none;"' : '' ?>>
          ...
          <span id="address1" class="text-danger" generated="true"><?php echo form_error('address'); ?></span> </label>
        </div>
        <!-- <div class="col-lg-8 col-md-8 col-sm-12 col-12"></div> -->
        <!-- <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="step-form-heading">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
          <label> Target Number of Tickets <span class="float-right" data-toggle="tooltip" data-placement="top" title="This is Target Number of Tickets"><i class="fas fa-question-circle"></i></span>
          <input type="number" id="goal" name="goal" min="1" value="<?php echo $gig->ticket_limit ?>" required="required" <?php echo $gig->status ? 'disabled' : '' ?>>
          <span id="goal1" class="text-danger" generated="true"><?php echo form_error('goal'); ?></span> </label>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
          <label> Ticket Threshold <span class="float-right" data-toggle="tooltip" data-placement="top" title="This is Ticket Threshold. It must be less than Target number of tickets."><i class="fas fa-question-circle"></i></span>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
          ...
          <div id="campaign-date-input">
            ...
            <span id="campaign_date1" class="text-danger" generated="true"><?php echo form_error('campaign_date'); ?></span> </div>
          <?php
                      // endif;
                      ?>
          </label>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
          ...
          <span id="gig_date1" class="text-danger" generated="true"><?php echo form_error('gig_date'); ?></span> </label>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
          <label> Start Time
          ...
          <span id="start_time1" class="text-danger" generated="true"><?php echo form_error('start_time'); ?></span> </label>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
          <label> End Time
          ...
          <span id="end_time1" class="text-danger" generated="true"><?php echo form_error('end_time'); ?></span> </label>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
          <div class="mycheckbox-contain">
            <div class="allow-overshoot">
              ...
              <span></span> </div>
            <span id="is_overshoot1" class="text-danger" generated="true"><?php echo form_error('is_overshoot'); ?></span> </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 col-12"></div>
        </div>
        <div class="row">
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12 col-12 tier_bundles">
                    ...
                    <div class="row mb-2">
                      ...
                      <div class="col-md-4">
                        ...
                        <!-- <input type="hidden" class="old_image" value="<?php //echo bundle_url() . $bundle->
                        image
                        ?>"> -->
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-12 mt-3">
              <div id="tier1">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12 col-12 tier_bundles">
                    <label class="d-none mb-0"> Products </label>
                  </div>
                  <div class="col-lg-12 col-md-4 col-sm-12 col-12">
        ...
        <div class="panel panel-primary setup-content" id="step-4">
          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
              <label> Select the meeting platform
