              ...
              <form id="form_step_1" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12 col-12 mt-4" id="div_video">
                    <p><i class="fas fa-video"></i> Upload Pitch Video <small class="text-warning">max 5mb</small><span class="float-right" data-toggle="tooltip" data-placement="top" title="This is Gig pitch video"><i class="fas fa-question-circle"></i></span></p>
                    <!-- or Pitch Video -->
