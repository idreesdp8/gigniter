                ...
                <div class="row">
                  ...
                  <!-- <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                    <label>
                      ...
                      or Pitch Video
                      <div>
                        <img class="object-fit-cover" id="img" src="<?php echo $gig->poster ? poster_url() . $gig->poster : user_asset_url() . 'images/icons/img-demo-bg.png' ?>" alt="your image" /> <a><img src="<?php echo $gig->poster ? '' : user_asset_url() . 'images/icons/img-plus.png' ?>" id="icon_for_upload"></a>
            <input type='file' name="poster" id="poster" hidden="hidden" accept="image/*" onChange="readURL(this);" />
          </div>
          </label>
        </div>
              ...
              <div class="panel panel-primary setup-content" id="step-3">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                    <label>
                      Stripe Email
                      <input type="text" id="stripe" name="stripe" value="<?php echo isset($user) ? $user->stripe : null ?>" <?php echo (!isset($user) || (isset($user) && $user->stripe == ''))  ? 'required="required"' : '' ?>>
                    </label>
                  </div>
                  <div class="col-lg-6 col-md-6 col-sm-12 col-12"></div>
                </div>
