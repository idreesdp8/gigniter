...
<body>
    ...
    <!-- ==========photo-Section========== -->
    <section class="section-summery">
        <div class="container video-container">
            <div class="row mb-3">
                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                    <h5>Event started :<span style="color: #F1C400;font-weight: 700;"> 01:04:00</span></h5>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row video-below">
                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="custom-text mt-3">
                        <h5 class="title">Dekmantel</h5>
                        <h6>Tylor Swift</h6>
                        <p>Music <span class="mr-1 ml-1">|</span> Show <span class="mr-1 ml-1">|</span> English</p>
                    </div>
                </div>
            </div>
            <div class="row video-below">
