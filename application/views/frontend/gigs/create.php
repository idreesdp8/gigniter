              ...
              <div class="panel panel-primary setup-content" id="step-1">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12 col-12" id="div_image">
                    <p>Upload Gig Poster <i class="fas fa-images"></i> <small class="text-warning">min 360px x 354px</small> <span class="float-right" data-toggle="tooltip" data-placement="top" title="This is Gig Poster"><i class="fas fa-question-circle"></i></span></p>
                    <!-- or Pitch Video -->
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12 col-12 mt-4" id="div_video">
                    <p>Upload Pitch Video <i class="fas fa-video"></i> <small class="text-warning">max 5mb</small><span class="float-right" data-toggle="tooltip" data-placement="top" title="This is Gig pitch video"><i class="fas fa-question-circle"></i></span></p>
                    <!-- or Pitch Video -->
