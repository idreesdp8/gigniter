            ...
            <div class="stepwizard">
              <div class="stepwizard-row row setup-panel">
                <div class="stepwizard-step">
                  <a href="#step-1" type="button" class="btn btn-default btn-circle line progress_step_1 btn-success-circle">1</a>
            ...
            <div class="panel">
                ...
                <form id="form_step_1">
                  ...
                  <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                      <label>
                        Enter Gig Title
                        <input type="text" id="title" name="title" data-error="#title1">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                      <label>
                        Enter Gig subtitle
                        <input type="text" id="subtitle" name="subtitle" data-error="#subtitle1">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                      <label>
                        Enter Gig Category
                        <select id="category" name="category" class="select" data-error="#category1">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                      <label>
                        Enter Gig Genre
                        <select id="genre" name="genre" class="select" data-error="#genre1">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                      <label>
                        Enter Address
                        <input type="text" id="address" name="address" data-error="#address1">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                      <label>
                        Enter Goal
                        <input type="text" id="goal" name="goal" data-error="#goal1">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                      <label>
                        ...
                        <input type="text" id="campaign_date" class="date" name="campaign_date" onfocus="(this.type='date')" onblur="if(!this.value)this.type='text'" data-error="#campaign_date1">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                      <label>
                        Gig Date
                        <input type="text" id="gig_date" class="date" name="gig_date" onfocus="(this.type='date')" onblur="if(!this.value)this.type='text'" data-error="#gig_date1">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                      <label>
                        Start Time
                        <input type="text" id="start_time" class="time" name="start_time" onfocus="(this.type='time')" onblur="if(!this.value)this.type='text'" data-error="#start_time1">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                      <label>
                        End Time
                        <input type="text" id="end_time" class="time" name="end_time" onfocus="(this.type='time')" onblur="if(!this.value)this.type='text'" data-error="#end_time1">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                      <div class="mycheckbox-contain">
                        <div class="allow-overshoot">
                          <input id="myCheckbox-allow_overshoot" type="checkbox" name="is_overshoot" value="1" data-error="#is_overshoot1">
                ...
                <form id="form_step_2">
                  ...
                  <div id="tier1">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                        <button type="button" class="btn btn-primary add_tier_bundle" data-bundle="1" data-tier="1">Add Bundle</button>
                      </div>
                    </div>
                  </div>
                  <hr>
                  ...
                  <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-12 col-12">
                      <button type="button" class="btn btn-primary btn-step-continue nextBtn" data-step="2">save & Continue</button>
                    </div>
                    <div class="col-lg-9 col-md-9 col-sm-12 col-12"></div>
                  </div>
                </form>
              ...
              <div class="panel-primary setup-content fade" id="step-3">
                <form id="form_step_3">
                  ...
                  <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-12 col-12">
                      <button type="button" class="btn btn-primary btn-step-continue nextBtn" data-step="3">save & Continue</button>
                    </div>
                    <div class="col-lg-9 col-md-9 col-sm-12 col-12"></div>
                  </div>
                </form>
              ...
              <div class="panel-primary setup-content fade" id="step-4">
                <form id="form_step_3">
                  <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                      <div class="step-form-heading">
                  ...
                  <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-12 col-12">
                      <button type="button" class="btn btn-primary btn-step-continue nextBtn" data-step="4">save & Continue</button>
                    </div>
                    <div class="col-lg-9 col-md-9 col-sm-12 col-12"></div>
                  </div>
                </form>
              ...
              <div class="panel-primary setup-content fade" id="step-5">
                <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="step-form-heading">
