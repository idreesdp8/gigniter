        ...
        <div class="container">
            <div class="padding-top padding-bottom">
                <div class="account-area">
                    ...
                    <form class="account-form" id="datas_form" action="<?php echo site_url('account/create_account'); ?>" method="post">
                        <div class="form-group">
                            <label for="email1">Email<span>*</span></label>
                            <input type="text" placeholder="Enter Your Email" name="email" id="email" value="<?php echo $email ?>" data-error="#email1" readonly>
                            <input type="hidden" name="encoded_email" value="<?php echo $encoded_email ?>">
