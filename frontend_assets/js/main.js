(function ($) {
  ...
  $(document).ready(function () {
    ...
    var owlT2 = $('.speaker-slider2');
    owlT2.owlCarousel();
    // Go to the next item
    $('.speaker-next2').on('click', function () {
      owlT2.trigger('next.owl.carousel');
    })
    // Go to the previous item
    $('.speaker-prev2').on('click', function () {
      owlT2.trigger('prev.owl.carousel', [300]);
    })
    //Speaker Slider 3
    $('.speaker-slider3').owlCarousel({
      loop: true,
      responsiveClass: true,
      nav: false,
      dots: false,
    ...
    var owlT3 = $('.speaker-slider3');
    owlT3.owlCarousel();
    // Go to the next item
    $('.speaker-next3').on('click', function () {
      owlT3.trigger('next.owl.carousel');
    })
    // Go to the previous item
    $('.speaker-prev3').on('click', function () {
      owlT3.trigger('prev.owl.carousel', [300]);
    })
    //Speaker Slider 4
    $('.speaker-slider4').owlCarousel({
      loop: true,
      responsiveClass: true,
      nav: false,
      dots: false,
    ...
    var owlT4 = $('.speaker-slider4');
    owlT4.owlCarousel();
    // Go to the next item
    $('.speaker-next4').on('click', function () {
      owlT4.trigger('next.owl.carousel');
    })
    // Go to the previous item
    $('.speaker-prev4').on('click', function () {
      owlT4.trigger('prev.owl.carousel', [300]);
    })
    //Speaker Slider 5
    $('.speaker-slider5').owlCarousel({
      loop: true,
      responsiveClass: true,
      nav: false,
      dots: false,
    ...
    var owlT5 = $('.speaker-slider5');
    owlT4.owlCarousel();
    // Go to the next item
    $('.speaker-next5').on('click', function () {
      owlT5.trigger('next.owl.carousel');
    })
    // Go to the previous item
    $('.speaker-prev5').on('click', function () {
      owlT5.trigger('prev.owl.carousel', [300]);
    })
    //Speaker Slider mobile
    $('.speaker-slider-mobile').owlCarousel({
      loop: true,
      responsiveClass: true,
      nav: false,
      dots: false,
    ...
    var owlTB = $('.speaker-slider-mobile');
    owlTB.owlCarousel();
    // Go to the next item
    $('.speaker-next-mobile').on('click', function () {
      owlTB.trigger('next.owl.carousel');
    })
    // Go to the previous item
    $('.speaker-prev-mobile').on('click', function () {
      owlTB.trigger('prev.owl.carousel', [300]);
    })
    ...
    $('#start_gig_menu').click(function (e) {
      e.preventDefault();
      $.ajax({
        url: base_url + '/gigs/check_user_incomplete_gigs',
        dataType: 'json',
        method: 'GET',
        success: function (resp) {
          if (resp.status === 1) {
            swal({
              title: "You have " + resp.count + " incomplete gig(s). You want to complete?",
              icon: "info",
              buttons: true,
              buttons: ["No", "Yes"],
            }).then((willDo) => {
              if (willDo) {
                window.location.href = base_url + 'my_gigs'
              } else {
                window.location.href = base_url + 'gigs/add'
              }
            });
          } else {
            window.location.href = base_url + 'gigs/add'
